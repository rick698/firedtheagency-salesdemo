<?php
$currentBudget = isset($latestProject['budget_cents']) && $latestProject['budget_cents'] !== null
    ? (int) round(((int) $latestProject['budget_cents']) / 100)
    : 0;
ob_start();
?>
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="nav-list">
        ...
        <a href="<?= e(brand_url($brand, 'budget')) ?>" class="nav-link active">
...
<main class="main-content">
    <section class="dashboard-card">
        ...
        <?php if ($currentBudget > 0): ?>
            <p class="muted-copy">Your current monthly ad spend cap is:</p>
            <div class="scorecard-value accent">$<?= e(number_format($currentBudget)) ?> AUD</div>
            <p class="muted-copy">This is your budget before GST. Charges are processed as budget plus 10% GST.</p>
        <?php else: ?>
            <p class="muted-copy">No monthly ad spend budget has been set yet. When you set one, it will be charged as budget plus 10% GST.</p>
        <?php endif; ?>
    </section>
</main>
<?php
